...
final class ProgramsV2SmokeUITests: XCTestCase {
    ...
    private func tapWorkoutDefaultActionOrFail(_ app: XCUIApplication, name: String) {
        ...
        attachUITestDebug(app, name: "\(name)_CardActionNeverBecameHittable")
        XCTFail("Expected DayTimeline.WorkoutCard.DefaultAction to become hittable after scrolling.")
    }
}
